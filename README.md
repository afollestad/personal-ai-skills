...
- [`review-github-pr`](skills/review-github-pr/SKILL.md): Review a PR and submit suggestions as comments, along with an optional approval/request for changes.
...
```bash
npx skills add https://github.com/afollestad/skills -g --skill review-github-pr
```
